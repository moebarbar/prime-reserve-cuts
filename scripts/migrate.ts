...
async function run() {
  ...
  await pool.query(`
    ...
    SELECT * FROM (VALUES
      ('NY Strip',     'USDA Prime', 'Center-cut New York Strip · Bold, beefy, perfect sear',              '14 oz (397g)',  99,  49, 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=400&q=80&fit=crop&crop=center', TRUE),
      ('Tenderloin',   'USDA Prime', 'Center-cut Filet Mignon · The most tender cut, silky clean',         '8 oz (227g)',   119, 59, 'https://images.unsplash.com/photo-1588168333986-5078d3ae3976?w=400&q=80&fit=crop&crop=center', TRUE),
      ('Ribeye',       'USDA Prime', 'Bone-in Ribeye · Rich marbling, buttery char',                       '16 oz (454g)',  89,  55, 'https://images.unsplash.com/photo-1600891964092-4316c288032e?w=400&q=80&fit=crop&crop=center', TRUE),
      ('A5 Wagyu',     'A5 Wagyu',   '12oz Japanese Miyazaki striploin · extraordinary marbling',          '12 oz (340g)',  189, 95, 'https://images.unsplash.com/photo-1558030006-450675393462?w=400&q=80&fit=crop&crop=center', TRUE),
      ('Tomahawk',     'Heritage',   '40oz long-bone cowboy cut · dry-aged Heritage breed',                '40 oz (1134g)', 229, 115,'https://images.pexels.com/photos/12261087/pexels-photo-12261087.jpeg?auto=compress&cs=tinysrgb&w=400', TRUE)
    ) AS v(name, grade, detail, weight, price, price_per_week, img, available)
