  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.steakStrip}>
        {[
          { src: 'https://images.unsplash.com/photo-1611564494260-6f21b80af7ea?w=800&q=75&fit=crop&crop=center', name: 'Tomahawk Ribeye', price: '$229/mo', priority: true },
          { src: 'https://images.unsplash.com/photo-1600891964092-4316c288032e?w=500&q=75&fit=crop&crop=center', name: 'Ribeye', price: '$89/mo' },
          { src: 'https://images.unsplash.com/photo-1588168333986-5078d3ae3976?w=500&q=75&fit=crop&crop=center', name: 'Filet Mignon', price: '$119/mo' },
          { src: 'https://images.unsplash.com/photo-1558030006-450675393462?w=500&q=75&fit=crop&crop=center', name: 'A5 Wagyu', price: '$189/mo' },
        ].map((cut, i) => (
